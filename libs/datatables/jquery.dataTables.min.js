...
a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Primera",sLast:"Ultima",sNext:"Siguiente",sPrevious:"Anterior"},sEmptyTable:"No hay datos disponibles en la tabla",sInfo:"Viendo _START_ a _END_ de _TOTAL_ entradas",sInfoEmpty:"Viendo 0 a 0 de 0 entradas",
sInfoFiltered:"(filtrado de _MAX_ entradas totales)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Viendo _MENU_ Entradas",sLoadingRecords:"Cargando...",sProcessing:"Procesador...",sSearch:"Buscador:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No se encontraron registros coincidentes"},oSearch:h.extend({},l.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};
